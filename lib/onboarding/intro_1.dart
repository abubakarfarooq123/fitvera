      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 20, top: 12, right: 18),
              child: Text(
                "Main tools",
                style: GoogleFonts.poppins(
                    color: Colors.black,
            ...
            Padding(
              ...
              child: Text(
                "Minus et enim incidunt illo autem et pariatur quis \nvoluptatem. A eaque adipisci vitae omnis qui sunt \nautem sunt ratione.",
